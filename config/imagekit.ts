export const imagekitConfig = {
  urlEndpoint: "https://ik.imagekit.io/zzd6vidzm",
...
export const buildTransformationUrl = (
  ...
  if (imageUrl.includes("/demo/")) {
    ...
    try {
      ...
      // URLs are like: https://ik.imagekit.io/zzd6vidzm/filename.jpg
      // So pathname is: /zzd6vidzm/filename.jpg
      // We need to remove 'zzd6vidzm/' to get just 'filename.jpg'
      const accountId = imagekitConfig.urlEndpoint.split('/').pop() || '';
